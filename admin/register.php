...
// Proses register jika form dikirim
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name) || empty($email) || empty($username) || empty($password) || !$terms) {
        $error_message = "Semua field harus diisi dan Anda harus menyetujui syarat dan ketentuan.";
    } else {
        ...
        if ($result && $result->num_rows > 0) {
            ...
            $sql = "INSERT INTO admin (nama_lengkap, email, username, password) VALUES ('$name', '$email', '$username', '$hashed_password')";
